...
namespace AlbumOnline.Controllers
{
    ...
    public class PhotosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Img,User,Fecha,TipoId,Status")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Img,User,Fecha,TipoId,Status")] Photo photo)
        {
            if (ModelState.IsValid)
            {
